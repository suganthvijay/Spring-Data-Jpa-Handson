...
public class HqlApplication {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(HqlApplication.class);

	public static void main(String[] args) throws ParseException {
		ApplicationContext context = SpringApplication.run(HqlApplication.class, args);
