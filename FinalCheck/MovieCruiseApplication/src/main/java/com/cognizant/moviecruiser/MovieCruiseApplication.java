...
public class MovieCruiseApplication {

	private static final Logger LOGGER = LoggerFactory.getLogger(MovieCruiseApplication .class);

	private static MovieService movieService;

	public static void main(String[] args) {
		
		ApplicationContext context = SpringApplication.run(MovieCruiseApplication .class, args);
